...
const Hero = () => {
  return (
    <div className='bg-black text-white text-center py-16  '>
      <img src={HeroImg} alt="Hero" className='mx-auto mb-8 w-60 h-60 rounded-full object-cover  transform transition-transform duration-300 hover:scale-105 '/>
      <h1 className='text-4xl font-bold'>
        I'm {""}
        <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 '>Gikundiro Danny</span>
        , Full-Stack Developer
      </h1>
      <p className='mt-4 text-lg text-gray-300'>
        I specialized in bluiding modern and responsive Web application
      </p>
